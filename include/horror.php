...
// Query SQL per prendere i libri della categoria "Horror"
$sql = "SELECT Libri.Titolo, Libri.Descrizione, Libri.Anno_Pubblicazione, Libri.Lingua_Originale, Libri.ISBN, Categorie.Genere_Libro
        ...
        WHERE Categorie.Genere_Libro = 'Horror'";
    ...
    <body>
        ...
        <div class="riquadro">
            ...
            <div class="contenuto-libro">
                ...
                <?php elseif (count($libriHorror) === 0): ?>

                    <!-- Messaggio se non ci sono libri -->
                    <p>Nessun libro in categoria Horror trovato nel database.</p>
                ...
                <?php else: ?>
                    ...
                    <ul>
                        ...
                        <?php foreach ($libriHorror as $libro): ?>
