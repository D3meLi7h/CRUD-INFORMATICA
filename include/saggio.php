...
$sql = "SELECT Libri.Titolo, Libri.Descrizione, Libri.Anno_Pubblicazione, Libri.Lingua_Originale, Libri.ISBN, Categorie.Genere_Libro
        ...
        WHERE Categorie.Genere_Libro = 'Saggio'";
...
<html lang="it">
    ...
    <body>
        <div class="riquadro">
            ...
            <?php elseif (count($libriSaggio) === 0): ?>
                <p>Nessun libro in categoria Saggio trovato nel database.</p>
            <?php else: ?>
                <h3>Libri nella categoria Saggio</h3>
                <ul>
                    <?php foreach ($libriSaggio as $libro): ?>
                        <li>
