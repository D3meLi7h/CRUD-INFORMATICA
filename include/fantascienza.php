...
$sql = "SELECT Libri.Titolo, Libri.Descrizione, Libri.Anno_Pubblicazione, Libri.Lingua_Originale, Libri.ISBN, Categorie.Genere_Libro
        ...
        WHERE Categorie.Genere_Libro = 'Fantascienza'";
...
<html lang="it">
    ...
    <body>
        <div class="riquadro">
            <h1 class="titolo">Fantascienza</h1>
            ...
            <?php elseif (count($libriFantascienza) === 0): ?>
                <p>Nessun libro in categoria Fantascienza trovato nel database.</p>
            <?php else: ?>
                <h3>Libri nella categoria Fantascienza</h3>
                <ul>
                    <?php foreach ($libriFantascienza as $libro): ?>
                        <li>
