...
$sql = "SELECT Libri.Titolo, Libri.Descrizione, Libri.Anno_Pubblicazione, Libri.Lingua_Originale, Libri.ISBN, Categorie.Genere_Libro
        ...
        WHERE Categorie.Genere_Libro = 'Giallo'";
...
<html lang="it">
    ...
    <body>
        <div class="riquadro">
            ...
            <?php elseif (count($libriGiallo) === 0): ?>
                <p>Nessun libro in categoria Giallo trovato nel database.</p>
            <?php else: ?>
                <h3>Libri nella categoria Giallo</h3>
                <ul>
                    <?php foreach ($libriGiallo as $libro): ?>
                        <li>
