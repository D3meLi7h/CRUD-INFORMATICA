...
('Mario','Rossi','M','2005-04-15','Studente','Via Roma 10','Roma','3331234567','mario.rossi@email.com','mario.rossi','12345678');
...
('Horror', 'Storie dell''orrore e suspense'),
('Giallo', 'Misteri e investigazioni'),
('Manuale', 'Guide e testi tecnici'),
('Altro', 'Generi non classificati');
